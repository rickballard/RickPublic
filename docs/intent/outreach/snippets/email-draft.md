# Email Snippet (Copy/Paste)

Subject: Exploring a neutral guardrails pilot (60‑day scoped)
...
- Outcomes: (1) explain/undo, (2) reduced unsafe/low‑trust assists, (3) exportable audit logs.
- Model: non‑exclusive; no IP transfer on our core (AGPL core, Apache SDK).

If this aligns, could we schedule a 20‑minute scoping call?
